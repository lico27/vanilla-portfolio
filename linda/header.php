...
<body class="d-flex col-12">

<header class="d-flex col-12">

<navbar class="d-flex col-10 col-md-8 col-lg-6 col-xl-5 p-3">
  ...
  <!-- Hero -->
  <div class="text-center bg-body-tertiary col-10 col-md-8 col-lg-6 col-xl-5 d-flex" id="hero">
    <div>Image goes here</div>
  </div>
</header>

  <!-- Content -->
<section id="content" class="col-10 col-md-8 col-lg-6 col-xl-5 d-flex py-5">
